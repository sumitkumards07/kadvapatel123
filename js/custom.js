...
//    var disabledatesData = disabledates;
//
//    var holidayDates = new Array();
//    for (var i in disabledatesData) {
//        holidayDates.push(disabledatesData[i]);
//
//    }
...
//    if (holidayDates.indexOf(today) == -1)
//    {
...
//    var findate = new Date(nowDate.getFullYear(), nowDate.getMonth(), nowDate.getDate() + 18, 0, 0, 0, 0);
//    var findateend = new Date(nowDate.getFullYear(), nowDate.getMonth(), nowDate.getDate() + 23, 0, 0, 0, 0);
    // var disabledatesData = json2array(disabledates);


    //  alert(disabledatesData);
//    $(function () {
...
//                return holidayDates.indexOf(currDate) != -1;
//                // var isDisabled = (holidayDates.indexOf(currDate) == -1); // used to disable if its an holiday or weekend
//                //  return [isDisabled];
//            },
//            locale: {
//                format: 'YYYY/MM/DD'
